...
// import * as ENABLE3D from 'https://cdn.jsdelivr.net/npm/@enable3d/ammo-physics@0.25.0/dist/index.min.js'
...
class WorldDemo {
    ...
    //         if (!object.name.toUpperCase().includes('LIGHT') && !object.name.toUpperCase().includes('PLANE')) {
    //             this.physics.add.existing(this.scene.children[i])
    //         }
    //     })
    // }
